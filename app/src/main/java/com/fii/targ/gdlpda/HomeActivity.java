...
public class HomeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bindProductButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(HomeActivity.this, BindProductActivity.class);
        ...
        bindGroundButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(HomeActivity.this, BindGroundActivity.class);
                startActivity(intent);
            }
        });
        ...
        unbindButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(HomeActivity.this, UnbindActivity.class);
                startActivity(intent);
            }
        });
        ...
        callTrolleyButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(HomeActivity.this, CallTrolleyActivity.class);
                startActivity(intent);
            }
        });
        ...
        sendTrolleyButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(HomeActivity.this, SendTrolleyActivity.class);
                startActivity(intent);
            }
        });
        ...
        forkliftButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(HomeActivity.this, ForkliftActivity.class);
                startActivity(intent);
            }
        });
        // Info button
    ...
    private void initService() {
        ...
        adapter = new ExceptionAdapter(HomeActivity.this, exceptionList, new ExceptionAdapter.OnItemClickListener() {
            @Override
            ...
            public void run() {
                ...
                if (response.getCode().equals("0")) {
                    ...
                    runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            Toast.makeText(HomeActivity.this, "Failed to fetch exceptions: " + response.getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    });
                }    
            ...
            public void run() {
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        if (success) {
                            Toast.makeText(HomeActivity.this, "Exception cleared successfully", Toast.LENGTH_SHORT).show();
                            exceptionList.remove(exceptionItem);
                            adapter.notifyDataSetChanged();
                            updateExceptionCount();
                        } else {
                            Toast.makeText(HomeActivity.this, "Failed to clear exception", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
            }
